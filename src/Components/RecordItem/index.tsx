...
export default class RecordItem extends React.Component<RecordProps> {
    render() {
        return (
            <TouchableOpacity onPress={this.props.onPress} style={{ ...RecordItemStyles.rootContainer, backgroundColor: theme.recordBgC }}>
                ...
                <TouchableOpacity onPress={this.props.onIconPress} style={RecordItemStyles.checkbox}>
                    <Icon
